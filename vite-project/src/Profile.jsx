...
function Profile() {
    ...
    return (<>
        <div className="ml-20 mt-5 text-center flex flex-col gap-y-8 items-center shadow-xl w-90 h-102 mb-20 ">
            <div id="pr"><button className="border-none bg-white hover:none"><img
                ...
                <button type='button' className="mr-0 bg-white" id="buttonclick" onClick={() => handlebutton()}>
                    Change your profile</button><br></br><button className='bg-white border border-black shadow-xl'
            ...
            <form className="collapse pr-30" id="formelement">
                ...
                <button className='bg-white shadow-xl' type='button' onClick={(e) => handleSubmit(e)}>
                    Save changes</button>
            </form>
        </div></>
    )
